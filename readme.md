Welcome to the translation / language section of SMARTIUM call
...
There is a file called translate.js, which if you copy/paste the content (and hit enter) into the Chrome browser's console, while on SMARTIUM call, it will download the translation files.
...
the "blank.json" file contains a minimal template.  Little to no SMARTIUM call branding.
